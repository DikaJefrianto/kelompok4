        ...
        <form action="proses_mahasiswa.php?proses=simpan" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Membaca" id="hobi">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Memancing" id="hobi">
                        <label class="form-check-label" for="hobi">
                            Memancing
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Bermain" id="hobi">
                        <label class="form-check-label" for="hobi">
                            Bermain
                        </label>
                    </div>
        ...
        <form action="proses_mahasiswa.php?proses=edit" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="hobi" class="form-label">Hobi</label>
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Membaca" id="hobi" <?= in_array("Membaca", $hobbies) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="hobi">
                            Membaca
                        </label>
                    </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Memancing" id="hobi" <?= in_array("Memancing", $hobbies) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="hobi">
                            Memancing
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="hobi[]" type="checkbox" value="Bermain" id="hobi" <?= in_array("Bermain", $hobbies) ? 'checked' : '' ?>>
                        <label class="form-check-label" for="hobi">
                            Bermain
                        </label>
                    </div>
